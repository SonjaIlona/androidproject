/**Tässä luokassa kutsutaan fragment xml tiedostoa, josta viite sen omaan ragmentti-luokkaan, joka taas asettaa näkyvän
 * layoutin.
 * Tämä Aktiviteetti käynnistää myöskin tuon mainAktiviteetin
...
public class SplashScreen extends FragmentActivity {
    ...
    protected void doInit() {
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            @Override
            public void run() {
                // Tämä suoritetaan, kun asetettuaika ylitetty
                // käynnistetään pääluokka
